mountain_view_toc = [
    ...
    "APPENDIX.B.*DEPARTMENT COST CENTER",
    "APPENDIX.C.*GRIEVANCE FORM",
    "APPENDIX.D.*WAGE SCALES",
    "APPENDIX.E.*VSP WAGE SCALES",
    "APPENDIX.F.*SIDE LETTER TO ARTICLE 29",
    "APPENDIX.G.*SIDE LETTER RE VSP PATIENT SITTER WAGE RATES",
    "APPENDIX.H.*SIDE LETTER REGARDING FAMILY ILLNESS PAY",
    "APPENDIX.I.*SIDE LETTER",
    "APPENDIX.J.*SIDE LETTER MARKET ADJUSTMENTS",
    "APPENDIX.K.*SIDE LETTER RE: ARTICLE 8",
]